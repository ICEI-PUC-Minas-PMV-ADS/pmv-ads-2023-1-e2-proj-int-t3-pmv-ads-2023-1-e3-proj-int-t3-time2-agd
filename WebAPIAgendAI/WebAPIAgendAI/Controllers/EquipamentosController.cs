...
namespace WebAPIAgendAI.Controllers
{
    public class EquipamentosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("NumeroSerie,Modelo,Status")] Equipamento equipamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("NumeroSerie,Modelo,Status")] Equipamento equipamento)
        {
