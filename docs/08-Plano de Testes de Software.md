...
| Passos 	| - Acessar a aplicação <br> - Informar o endereço do site <br> - Clicar em "Login" <br> - Preencher os campos obrigatórios (email e senha) <br> - Clicar em "Entrar" |
...
| Passos 	|  - Acessar a aplicação <br> - Informar o endereço do site <br> - Clicar em "Admnistrador" <br> - Clicar em "Equipamentos" <br>- Preencher os campos obrigatórios em Cadastro de Equipamentos(Hostname, Nº de Série, Sistema Operacional, Modelo, Quantidade) <br> - Clicar em "Cadastrar"|
...
| Passos 	| Acessar a aplicação  <br> - Informar o endereço do site <br> - Clicar em "Login" <br> - Preencher os campos obrigatórios com informações erradas (email e senha) <br> - Clicar em "Entrar" <br> - Um "balão" de aviso deve subir alertando o usuário sobre o erro |
...
| Passos 	| - Acessar a aplicação  <br> - Informar o endereço do site <br> - Clicar em "Login" <br> - Preencher os campos obrigatórios (email e senha) <br> - Clicar em "Entrar" <br> - Repetir esse processo duas vezes, sendo a primeira com o perfil de administrador e a segunda com o perfil de professor |
